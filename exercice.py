...
fenetre = tkinter.Tk()
fenetre.geometry("380x180+450+200")
...
btn2 = tkinter.Button(fenetre , text="Rénitialiser" , command=effacer,  bd=3, font=("sans serif",10,"bold"))
btn3 = tkinter.Button(fenetre, text="Quitter", command=quitter,  bd=3, font=("sans serif",10,"bold") )
...
btn.grid(column=0 , row=2 , pady=25)
